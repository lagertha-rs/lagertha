...
- **rnsc** - CLI for compiling and assembling RNS input
- **rns-lsp** - Language server for RNS tooling support

The project was briefly split into multiple repositories, but the source now lives here again as a single workspace.
...
- `rns-lang`: In early development, aims to provide an assembler for Java bytecode similar to `jasmin`. Test data will
