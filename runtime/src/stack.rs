...
impl FrameStack {
    ...
    fn cur_frame_mut(&mut self) -> Result<&mut JavaFrame, JvmError> {
        self.frames.last_mut().ok_or(JvmError::FrameStackIsEmpty)
    }

    fn cur_frame(&self) -> Result<&JavaFrame, JvmError> {
...
impl JavaFrame {
    ...
    fn params_to_frame_locals(params: Vec<Value>, max_locals: usize) -> Vec<Option<Value>> {
    ...
    pub fn new(
        ...
        Ok(Self {
            locals: Self::params_to_frame_locals(params, max_locals),
