...
The primitive type integration tests are now **comprehensive and complete** for all integer-based numeric types (int, long, short, byte, char) and boolean. The addition of:
...
The test suite should now effectively validate the ToyJVM's handling of primitive type operations, edge cases, and error conditions.

## Notes for Test Execution

- Tests require Java 24.0.2 to compile and run
